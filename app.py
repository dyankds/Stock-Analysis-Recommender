...
HALAL_UNIVERSE = {
    ...
    "5183.KL":{"name":"IHH Healthcare",    "sector":"Healthcare",       "market":"MY",  "halal":True,  "type":"equity"},
    "1082.KL":{"name":"Hong Leong Bank",   "sector":"Islamic Banking",  "market":"MY",  "halal":True,  "type":"equity"},
    # === CHINA (US-listed ADRs – extra Sharia due diligence required) ===
    "BABA":   {"name":"Alibaba Group",     "sector":"E-Commerce",       "market":"CN",  "halal":True,  "type":"equity"},
    "BIDU":   {"name":"Baidu Inc",         "sector":"Technology",       "market":"CN",  "halal":True,  "type":"equity"},
    "JD":     {"name":"JD.com",            "sector":"E-Commerce",       "market":"CN",  "halal":True,  "type":"equity"},
    "PDD":    {"name":"PDD Holdings",      "sector":"E-Commerce",       "market":"CN",  "halal":True,  "type":"equity"},
    "BEKE":   {"name":"KE Holdings",       "sector":"Real Estate Tech", "market":"CN",  "halal":True,  "type":"equity"},
}
...
with st.sidebar:
    ...
    selected_markets  = st.multiselect("Markets", ["US","EU","CN","MY","LSE","TW"], default=["US","EU","CN","MY"])
